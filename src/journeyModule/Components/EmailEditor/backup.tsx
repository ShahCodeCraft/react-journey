...
//             if (selectedCampaign) {
//     try {
//         const response = await axios.patch(`${environment.UrlEndpoint}journey/updateEmailCampaign/${selectedCampaign._id}`, campaignData);
...
// } else {
//     try {
//         const response = await axios.post(`${environment.UrlEndpoint}journey/uploadEmailCampaign`, campaignData);
...
//   const fetchData = async () => {
//     try {
//       const response = await fetch(`${environment.UrlEndpoint}journey/gellAllEmailTemplates`);
//       if (!response.ok) {
