...
// const WebPushHandlePort: React.FC<WebPushHandleProps> = ({ id, data, isConnectable }) => {
...
//                 <div>
//                 <div className="mb-2 absolute left-3 top-1  "><FontAwesomeIcon icon={faBell} style={{ color: "#858d93" }} /></div>
...
//                     id="Submitted"
//                     className="border border-blue-500 w-2 h-2 rounded-full"
//                     isConnectable={isConnectable}
//                     style={handleStyle}
//                 />
//             </div>
...
import { Handle, Position, useReactFlow } from 'reactflow';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faEnvelope, faBoltLightning, faDatabase, faXmark, faAngleRight, faDoorOpen, faTrashCan, faBell } from '@fortawesome/free-solid-svg-icons';
import { deleteNode, updatedData } from "../../reducer/slice";
import { useDispatch } from 'react-redux';
...
const WebPushHandlePort: React.FC<HandlesPortProps> = ({ id, data, isConnectable }) => {
  const [isPopupOpen, setIsPopupOpen] = useState(false);
  ...
  return (
    ...
    >
      ...
      {/* <div className=" bg-slate-900 py-3 px-10 w-32 border border-red-300 rounded-lg  hover:shadow-nodes"> */}
      <div className="py-3 px-10 w-32 border border-white rounded-lg hover:shadow-nodes" style={{ background: 'linear-gradient(to bottom, #3DC2EC 50%, #4B70F5 50%)' }}>
        ...
        {!isPopupOpen && (
          <div className='  '>
            ...
            <div  >
              ...
              <div className="mb-2 absolute left-3 top-1"><FontAwesomeIcon icon={faBell} style={{ color: "white" }} /></div>
            ...
            <div className="flex items-center relative ">
              <div
                className={`bg-[#3DC2EC]   border border-white rounded-sm shadow-md relative left-[76px]   mr-2 flex justify-center items-center ${isHovered ? 'transform rotate-45' : ''
