...
//   console.log(id)
//   // const [inc, setInc] = useState(0); // Initialize inc state to 0


//   let inc = 0;
//   useEffect(() => {
//     // Increment inc when the component is rendered
//     inc++
//     console.log(inc)
//   }, [id]);
...
//           <div>
//             <div className="mb-2 absolute left-3 top-1  "><FontAwesomeIcon icon={faWhatsapp} style={{ color: "#858d93" }} /></div>
//             {/* <FontAwesomeIcon icon="fa-regular fa-envelope"  /> */}
//             <h5 className="mb-2 text-[7px] font-bold tracking-tight absolute left-8 top-2 text-gray-700">{data.label}</h5>
//             <p className="mb-2 text-[6px] font-light  tracking-tight absolute left-8 top-4 text-gray-700">User WhatsApp connection</p>
...
const WhatsappHandlePort: React.FC<HandlesPortProps> = ({ id, data, isConnectable }) => {
  const [isPopupOpen, setIsPopupOpen] = useState(false);
...
<Handle
      ...
      {/* <div className=" bg-slate-900 py-3 px-10 w-32 border border-white rounded-lg  hover:shadow-nodes"> */}
      {/* <div className="py-3 px-10 w-32 border border-white rounded-lg hover:shadow-nodes" style={{ background: 'linear-gradient(to bottom, red 50%, slategray 50%)' }}> */}
      <div className="py-3 px-10 w-32 border border-white rounded-lg hover:shadow-nodes" style={{ background: 'linear-gradient(to bottom, #00A884 50%, #0A332C 50%)' }}>
        ...
        {!isPopupOpen && (
          <div className='  '>
            ...
            <div  >
              <div className="mb-2 absolute left-3 top-0"><FontAwesomeIcon icon={faWhatsapp} style={{ color: "white" }} /></div>
              ...
              {/* <hr className="absolute left-1 top-6 w-full border-b-1 border-gray-400" /> */}
            </div>

            <div className="flex items-center relative ">
              <div
                className={`bg-[#00A884]  border border-white rounded-sm shadow-md relative left-[76px]   mr-2 flex justify-center items-center ${
...
export default WhatsappHandlePort;
